...
{
    public class QuestionarioSatisfacaoTestes
    {
        [Fact]
        public void CalcularPorcentagens_DeveRetornarPorcentagensCorretas()
        {
            // Arrange
        ...
        [Fact]
        public void ObterRelatorioCumulativo_DeveRetornarRelatorioCorreto()
        {
            // Arrange
            var questionario = new QuestionarioSatisfacao();
